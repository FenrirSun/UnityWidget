...
{
    public class TMP_SDFShaderGUIColorGradient : TMP_BaseShaderGUI
    {
        ...
        static TMP_SDFShaderGUIColorGradient()
        {
        ...
        {
            EditorGUI.indentLevel += 1;
            DoLDRColor("_OutlineColor", "Color");
        ...
        void DoUnderlayPanel()
        {
            ...
            DoLDRColor("_UnderlayColor", "Color Out");
            ...
            DoLDRColor("_UnderlayColor2", "Color In");
            DoSlider("_UnderlayOffsetX2", "Offset2 X");
            DoSlider("_UnderlayOffsetY2", "Offset2 Y");
            DoSlider("_UnderlayDilate2", "Dilate2");
            DoSlider("_UnderlaySoftness2", "Softness2");
        ...
        {
            EditorGUI.indentLevel += 1;
            DoLDRColor("_SpecColor", "Specular Color");
            EditorGUI.indentLevel -= 1;
            EditorGUILayout.Space();
        }
        ...
        {
            EditorGUI.indentLevel += 1;
            DoLDRColor("_ReflectFaceColor", "Face Color");
            DoLDRColor("_ReflectOutlineColor", "Outline Color");
        ...
        {
            EditorGUI.indentLevel += 1;
            DoTexture2D("_ColorGradientTex", "ColorGradientTex");
            DoSlider("_UseColorGradient", "UseColorGradient");
        ...
        void DoMaskTexSubgroup()
        {
            ...
            DoLDRColor("_MaskEdgeColor", "Edge Color");
        ...
        GUIContent s_TempLabel = new GUIContent();
        protected void DoLDRColor(string name, string label)
        {
