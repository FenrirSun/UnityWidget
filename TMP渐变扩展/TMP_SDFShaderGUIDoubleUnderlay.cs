...
{
    public class TMP_SDFShaderGUIDoubleUnderlay : TMP_BaseShaderGUI
    {
        ...
        static TMP_SDFShaderGUIDoubleUnderlay()
        {
        ...
        void DoUnderlayPanel()
        {
            ...
            DoColor("_Underlay2Color", "Color");
            DoSlider("_UnderlayOffsetX", "Offset Y 2");
            DoSlider("_UnderlayDilate", "Dilate");
            DoSlider("_UnderlaySoftness", "Softness");
            DoSlider("_VolumetricLoop", "Volumetric Loop");
            EditorGUI.indentLevel -= 1;
            EditorGUILayout.Space();
        }
